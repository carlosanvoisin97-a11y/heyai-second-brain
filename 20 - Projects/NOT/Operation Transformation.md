...
- [ ] **#p1 Carlo**: inviare a Federico+Simone **email con la condizione vincolante sine qua non** (consegna codice sorgente + spec modello base + spec per training di terzi, così che un altro sviluppatore possa ritrainare) e attendere **conferma scritta** _[decisione team 9/6 — il lock-in è rischio HeyAI, non NoLoop]_ _[update 11/6 sera, decisione Carlo: non più email separata — condizione integrata nella sezione Contrattualistica dell'**email unica punti aperti** a F+S (bozza in [[00 - Inbox/2026-06-11 - BOZZA Email interna Federico+Simone post call Eye Cookies 11-6]]) con richiesta esplicita di conferma per iscritto in risposta; resta l'attesa della conferma scritta]_
...
- 2026-06-11 — `dbd591c6` (Code) — call bisettimanale Eye Cookies 11/6 con ricadute cross-cluster su OT: connettività/Microlog, call dati con Carmen, real-time/near-real-time come evolutive premium. Recap + email (Germano, Carmen, interna team). → [[80 - Sources/Cowork Sessions/code-recap/2026-06-11 - claude-main-dbd591c6|claude-main (dbd591c6)]]
...
- **Contratto**: bozza inviata via email — **nessun feedback mai ricevuto** (riconferma 12/6). La revisione della parte IP è in attesa del feedback Federico+Simone su accordo quadro + OE: da lì si deriva la struttura IP dei contratti verso NoLoop/NOT (schema e dettaglio in [[_Wave 2 NoLoop|Wave 2 NoLoop]] Log 12/6).
