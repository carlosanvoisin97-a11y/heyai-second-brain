...
- [ ] **#p1 Carlo**: allinearsi con [[Federico Saladino (Soolutions)|Federico]]+[[Simone Montanari (Soolutions)|Simone]] su disponibilità giovedì 15:30 ricorrente — prerequisito per mandare invito Teams a Germano
...
- [ ] **#p1 Simone (team sviluppo)**: sollecito Alex (team hardware) su **proposta scritta + render 2 opzioni Totem** — Opzione A (hardware riciclato/neutro/durevole "telecamere-style") + Opzione B (scenografico/plastica-legno/fieristico/brandizzabile per cliente). Entrambe da portare al cliente nel prossimo bisettimanale. Carlo in call: *"facciamoglielo vedere entrambe, magari già se riusciamo a fare un paio di render adesso"*. Confermare specifica edge computing (cache locale terminale → robustezza a outage connettività, costo "centinaia di euro non migliaia")
...
- [ ] **#p2 Carlo**: proporre a Germano **bisettimanale Operation Transformation alternato a Eye Cookies** (Carlo in call: *"se vogliamo fissarci anche un bisettimanale, magari li alterniamo, una volta ci sentiamo su i cookies, una volta su operation"*. Germano OK condizionato a conferma Massi su Germano-as-tech-Operation. Da inserire in email follow-up
- [ ] **#p2 Carlo**: in attesa preventivo Microlog **near real-time API** conferma esplicita Germano in call 28/5: *"oggi poi ho richiesto un preventivo per il Real Time o near Real Time"*. Carry-over già aperto dal 25/5, ora con conferma diretta. Monitoraggio costi/benefici vs batch G+1 in scope MVP a valle preventivo
