...
> Fornitore **in valutazione** — primo contatto operativo aperto da Luca Fratini (CEO) il 12/5/2026 via mail. Scope esatto e modello commerciale da definire in slot allineamento.
...
- **Sito**: aegiscore.tech
- **Sede**: Via Eleonora Duse 53, Roma
- **Referente unico**: [[60 - People/Luca Fratini (Aegiscore)|Luca Fratini]] — CEO
- **Telefono Luca**: +39 328 629 1538
- **Scope tecnico**: TBD (da definire post-call allineamento)

## Stato attuale

🟡 **In valutazione** — non ancora ingaggiato. Aperto topic operativo prima della decisione di inserimento nel pool fornitori HeyAI (oggi attivi: Soolutions, Silencio, Jakala — vedi [[_Area - Partnership Fornitori]]).

## Topic aperti pre-ingaggio

### 1. Ownership codice sorgente

**Formula proposta da HeyAI**:
- Proprietà HeyAI piena sul deliverable
- Diritto Aegiscore di riutilizzare **componenti tecniche generiche** (non specifiche al cliente HeyAI)
- Esclusione esplicita di riutilizzo su **clienti concorrenti diretti** di HeyAI

Da validare con Luca in slot allineamento.

### 2. Tempistiche delivery per progetto

Da validare per ogni progetto candidato all'outsourcing prima di formalizzare l'ingaggio.

### 3. Modello commerciale

TBD — da chiarire se subappalto puro, partnership, o altro modello.

## Progetti potenziali

_(nessuno assegnato — fornitore in valutazione)_

## Decisioni strategiche

| Data | Decisione | Stato |
|---|---|---|
| 2026-05-14 | Creazione schede persona + fornitore per tracking pre-ingaggio | ✅ |
...
### 2026-05-12
- Apertura via mail Luca Fratini → Carlo (ore 16:21). Topic: allineamento operativo, ownership codice, tempistiche progetti.
