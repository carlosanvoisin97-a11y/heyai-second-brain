...
| **F4 — Organizzazione sessioni/worktree** | ❌ NOT-STARTED | — | Convenzione worktree (lifecycle/naming/pruning), struttura cartelle, pipeline recap→vault |
