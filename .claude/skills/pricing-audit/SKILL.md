...
5. **Drift cross-file**: il numero che sto per consegnare è coerente con Master Facts, scheda progetto e CLAUDE.md §6? In dubbio: girare il sub-check `contradictions` di [[../vault-health/SKILL.md|vault-health]] sul progetto. Dopo la consegna: propagare il numero nuovo a Master Facts E scheda (§14: mai una sola).
