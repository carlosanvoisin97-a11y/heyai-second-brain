...
- [ ] **#p1** Carlo: follow-up [[Elena Chiti]] se non arrivato format quotazione cliente **entro 27/5 mattina** — input necessario per sezione Economics pitch _da Sessione Cowork 26/5 — PM Digest 27/5_
- [ ] **#p1** Carlo: rispondere a **Laila El Zieny** (laila.elzieny@noloop.eu, email 26/5 10:44) — chiede WhatsApp per "questione logistica" su NOT/Modulo Gestione Vendite; coordinare disponibilità + capire ruolo nel progetto [[Operation Transformation]] ⚠️ **[DA TRIAGIRE — persona non in vault]** _da email Laila 26/5 — PM Digest 27/5_
...
- [ ] **#p1** Carlo: leggere segnalazioni Eldis da [[Stefania Solidoro]] (21/5 16:03, 2 punti critici + allegati) + leggere report Simone (21/5 13:55, modifiche Builder dense) → coordinare fix _da email Stefania+Simone 21/5 — PM Digest 22/5_
- [ ] **#p1** Carlo: leggere proposta accordo retainer di [[Marco Longo (Morbinati & Longo)|Avv. Longo]] (mail 20/5 07:19) — propone modello alternativo al 4% stand-alone per gestire il carico legale crescente HeyAI → decidere e rispondere _da email Longo 20/5 — PM Digest 21/5_
- [ ] **#p1** Carlo+Simone: monitorare esito test catalogo Eldis di Marta Garrafa oggi 21/5 — fix rilasciato venerdì, 3 file SP attivi stamattina (Unik Table, Haier, Bosch); confermare stabilità o escalare _da email Simone+Marta 20/5 + SP 21/5 — PM Digest 21/5_
- [ ] **#p1** Carlo: rispondere ad Arianna Giordanella (NoLoop) su bug Crowd — girare lista completa a Federico+Simone con urgenza (evento Generali OGGI 20/5) _da email Arianna 19/5 18:00 — PM Digest 20/5_
- [ ] **#p1** Federico+Simone: fix bug Crowd nuovi da Arianna — modifica eventi post-creazione, form mapping campi duplicati, flag "seleziona tutti", editor landing accompagnatori, camera non modificabile rooming, export doppie con accompagnatori errato, sgancio automatico ospiti cancellati _da email Arianna 19/5 — PM Digest 20/5_
...
- [ ] **#p1** Carlo: verificare/rispondere a messaggio [[Elena Chiti]] su modello accesso Hub editoriale Engaged Research (atteso entro 9:30 OGGI 19/5) — pubblica vs community-only → impatta variante A/B nelle modifiche mockup _da Sessione Cowork local_b31cd243_
- [ ] **#p1** Carlo: brief [[Michele Mattucci]] 15 min sui feedback tecnici impattanti il codice mockup (PersonaSelect facoltativa, gender mix personas, 5° percorso Imprese, calcolatore borse RIMOSSO, Gateway prima Hub) _da Sessione Cowork local_b31cd243_
- [ ] **#p1** Modifiche mockup Angelini Academy entro pom mer 20/5: 5° percorso Imprese in sitemap+PersonaSelect, PersonaSelect facoltativa (scroll se non vuoi scegliere), Hub editoriale standalone (variante A pubblica o B login — dipende da Elena 9:30), Gateway prima Hub, calcolatore borse RIMOSSO, eventi interni con disclaimer non-cliccabili, "Report annuale Engaged Research", revisione copy ponte studente/Angelini, gender mix personas (due femminili in prime due posizioni) _da Sessione Cowork local_b31cd243_
...
- [ ] **#p1** Aggiungere bio [[Marco Morbidelli]] su `/press` + firma su Angelini People AREA 05 (30 min, copre richiesta brief slide 31) _da Sessione Cowork local_6a0ced23_
- [ ] **#p1** Sistemare `/engaged-network` mockup Angelini: completare 6 feature + 4-box partecipazione + Tier planet-orbite + sezione AI Co-pilot cosa fa/non fa (2-3h Claude Code) _da Sessione Cowork local_6a0ced23_
- [ ] **#p1** Decisione editoriale copy hero flagship (sobrio-Sage vs aspirational-Magician) _da Sessione Cowork local_6a0ced23_
...
- [ ] **#p1** Carlo: follow-up con [[Justin Lauro]] per definire nuova data switch BAT/PARD (Justin 14/5 ha confermato spostamento oltre il 15/5; attende risposta interna NOT) _da PM Digest 15/5_
- [ ] **#p1** Carlo: seguire up thread "AWS e OPENROUTER" — [[Marco Merli]] ha risposto 13/5 14:00 con allegato (forward email Stefano); coordinare con team tecnico che aspetta aggiornamenti DNS per chiusura settaggi Eye Cookies. Blocco tecnico deployment _da PM Digest 14/5_
- [ ] **#p1** [[Andrea Pazienza]]: preparare foglio condiviso simulazione cash-flow Wave 2 + NOT (assegnato da Carlo nell'email recap interno 13/5 17:57; discutere con Carlo + Elena per trovare la soluzione migliore) _da PM Digest 14/5_
- [ ] **#p1** Carlo: rispondere a [[Luca Fratini (Aegiscore)|Luca Fratini]] per fissare slot allineamento (mail 12/5 16:21); chiudere ownership codice sorgente con formula proposta (HeyAI proprietà + diritto Aegiscore di riutilizzare componenti tecniche generiche escluso clienti concorrenti diretti), validare tempistiche per ciascun progetto _da PM Digest 13/5_
- [ ] **#p1** Carlo+Michele: leggere "Analisi cluster utenti sito v.01.docx" inoltrato da [[Elena Chiti]] 13/5 09:51, valutare raggruppamento cluster 4 e 7, integrare nei doc strategici _da Elena 13/5_
- [ ] **#p1** Carlo+Andrea **producono DPA ex novo** per Wave 2 (Wave 1 DPA non esiste, va creato). Chiedere a Longo di sostituire Art. 10.2 "entro primo MVP" con "entro 30gg da sottoscrizione" per margine operativo _da [[_Wave 2 NoLoop|Wave 2 NoLoop]]_
...
- [ ] **#p1** Simone: integrazione **9 modifiche light** Builder Eldis concordate in call 8/5 (inversione default listino, ordinamento originale, codice/alias off di default, prezzo promo singolo, maschera campi a livello catalogo, etichette rinominabili, marchio campo attivabile vicino codice, persistenza filtri, varianti prezzo + testo descrittivo) _da [[Eldis Compilatore]]_
- [ ] **#p1** Simone: studi di fattibilità + quotazione **6 richieste extra Builder** Eldis (editor in-line descrizione+prezzo, logo brand come immagine, seconda immagine variante, catalogo immagini alternative, immagine testata+copertina dedicata, casistiche SET / layout multi-cella) _da [[Eldis Compilatore]]_
- [ ] **#p1** Eldis (Marta/team Marketing): invio via mail a Simone della **lista campi scheda prodotto** da esporre/escludere di default + lista campi da controllare a livello di intero catalogo _da [[Eldis Compilatore]]_
- [ ] **#p1** Carlo: integrare nei doc strategici Angelini Academy esistenti i nuovi insight emersi 11/5 (ricerca pedagogica UCL/IE Madrid, edTech, mismatching professionale, lifelong learning over 50, budget €5M su 2 anni a no-profit, mecenatismo famiglia Angelini) (scaduto 13/5) _da call 11/5_
- [ ] **#p1** HeyAI (Carlo+Michele): proseguire in autonomia analisi strategica + mockup + presentazione Angelini Academy → **ongoing fino al 22/5** _da call 11/5_
- [ ] **#p1** Attesa risposta [[Andrea Pasquali]] su proposta di chiusura **Allocazione PQ** rebalance Jakala (Carlo inviata 20:02 11/5) _da [[Jakala]]_
- [ ] **#p1** Chiamata o caffè con [[Marco Pasquali]] (cooling, 62gg+ silenzio, mentor informale + padre Andrea Pasquali) — questa settimana _da `crm-velocity` 12/5_
- [ ] **#p1** Sondare [[Tiziana Carnicelli]] sul concetto editoriale — Elena, entro **14/5** _(stale, verificare)_ _da prep call 11/5_
- [ ] **#p1** Tirare la corda IT [[Caterina Caboni]] per variante tecnica modulare Angelini Academy — [[Daniele Caporale]], entro **18/5** _da prep call 11/5_
- [ ] **#p1** Dimensionamento ore + range pricing Angelini — Carlo + [[Michele Mattucci]], entro **17/5** _da prep call 11/5_
- [ ] **#p1** Architettura prototipo sito Angelini + sezioni nuove (Talent Hub, Corporate Clients, Engaged Research Lab, profilo Morbidelli) — HeyAI, entro **20/5** _da prep call 11/5_
- [ ] **#p1** Bozza pitch deck v1 Angelini — Carlo + Daniele, entro **22/5** _da prep call 11/5_
- [ ] **#p1** Prototipo sito v1 Angelini (HTML navigabile) — HeyAI, entro **24/5** _da prep call 11/5_
- [ ] **#p1** Bozza proposta economica completa Angelini — Carlo + Elena, entro **26/5** _da prep call 11/5_
- [ ] **#p1** Consegna proposta al cliente Angelini — Daniele (+ Carlo), entro **31/5** _da prep call 11/5_
...
- [ ] **#p1** Risolvere BUG TIFF rendering Eldis (escalation tecnica) _da [[Eldis Compilatore]]_
- [ ] **#p1** Quotazione CR descrizione catalogo Eldis (Simone) _da [[Eldis Compilatore]]_
- [ ] **#p1** Prospetto hosting/manutenzione €130/mese con voci incluse (Federico+Simone) _da [[Eldis Compilatore]]_
- [ ] **#p1** Proposta supporto operativo / pacchetto ore €180/h Eldis (Federico+Simone) _da [[Eldis Compilatore]]_
- [ ] **#p1** Federico+Simone: documento aggregato proposte Eldis → Carlo lo commenta con Stefania _da [[Eldis Compilatore]]_
- [ ] **#p1** Soolutions: chiusura mancanze Builder Eldis (pulsante export + altra) entro 7/5 _(stale)_ _da [[Eldis Compilatore]]_
- [ ] **#p1** Simone: rispondere a [[Marta Garrafa]] sulle segnalazioni Unik Table + RAEE (email 6/5 14:41) _da [[Eldis Compilatore]]_
...
- [ ] **#p1** Decisione finale su scope da quotare Angelini Academy (sito puro, sito+altro, sito modulare?) _da [[_Angelini Academy|Angelini Academy]]_
- [ ] **#p1** Analizzare preventivo Achipont di Simone Soolutions (mail 7/5 17:02 — €10.000 MVP + opzionali) vs offerta Jakala €20K, e decidere fornitore _da [[Achipoint]] + [[2026-05-08]]_
- [ ] **#p1** Verificare/integrare valori Choice Lists Soolutions (Progetto, Owner, Priorità, Stato) + color coding _da [[99 - System/Workflow Delivery Soolutions]]_
- [ ] **#p1** Creare vista "Le mie task aperte" in Lists (filtro Owner contains Carlo + Stato ≠ Chiuso) _da [[99 - System/Workflow Delivery Soolutions]]_
- [ ] **#p1** Creare vista "Per progetto" in Lists (Group by Progetto + Stato ≠ Chiuso) _da [[99 - System/Workflow Delivery Soolutions]]_
- [ ] **#p1** Creare vista "P1 critiche" in Lists (Priorità = P1 + Stato ≠ Chiuso, ordina per Scadenza) _da [[99 - System/Workflow Delivery Soolutions]]_
- [ ] **#p1** Conditional formatting colonna Scadenza Lists (rosso bold se passata e Stato ≠ Chiuso) _da [[99 - System/Workflow Delivery Soolutions]]_
- [ ] **#p1** Doppio check 30 righe importate Lists (Owner / Scadenza / Stato / Priorità coerenti) _da [[99 - System/Workflow Delivery Soolutions]]_
- [ ] **#p1** Guest access Lists per `federico@soolutions.io` e `simone@soolutions.io` + verifica privacy _da [[99 - System/Workflow Delivery Soolutions]]_
- [ ] **#p1** Configurare notifica personale Lists (qualsiasi modifica, escluse le proprie) _da [[99 - System/Workflow Delivery Soolutions]]_
- [ ] **#p1** Mandare link Lists a Federico+Simone su WhatsApp/Teams **prima** del kickoff _da [[99 - System/Workflow Delivery Soolutions]]_
...
- [ ] **#p2** Carlo: valutare/risolvere **effetto 3D ponte** slide Angelini oppure deprioritizzare (rischio "troppo costoso" sollevato in call 26/5) _da Sessione Cowork 26/5 — PM Digest 27/5_
- [ ] **#p2** Carlo: valutare segnale Eldis — [[Stefania Solidoro]] ha ingaggiato IT interno ("Luciano") per valutazione installazione Compilatore-Builder su infrastruttura Eldis (26/5 13:15) → opportunità CR canone hosting/manutenzione _da email Stefania 26/5 — PM Digest 27/5_
- [ ] **#p2** Rispondere a [[Michele Mattucci]] (email 25/5 17:17) — fornire codice completo `src/components/CompassScrollAnimation/` per integrazione bussola 3D animata sito _da email Michele 25/5 — PM Digest 26/5_
- [ ] **#p2** Carlo: monitorare risposta [[Paolo Donzelli]] a materiale Wave 1+Wave 2 (inviato 21/5 17:45 — primo touchpoint diretto Donzelli in ~3 settimane) _da email Carlo→Donzelli 21/5 — PM Digest 22/5_
- [ ] **#p2** Carlo: rispondere a Nicolò (ODGroup) — confermare che parametri AWS/OpenRouter funzionano correttamente _da email Nicolò 19/5 06:54 — PM Digest 20/5_
- [ ] **#p2** Carlo: cronometrare pitch Angelini Academy in casa a vuoto prima del touchpoint gio 21/5 pom o ven 22/5 mattina (22 slide × 2 min target = 44 min) _da Sessione Cowork local_b31cd243_
- [ ] **#p2** Carlo: esercizio pre-call "Sì, hai ragione" su foglio sotto gli occhi + target tempo parlato ≤40% (recupero progressivo da 60-65% call 18/5) _da Sessione Cowork local_b31cd243_
- [ ] **#p2** Chiarire con [[Elena Chiti]] tassonomia OpCo sito Angelini (Tech vs Industrial Tech, Fater vs Consumer) — discrepanza mockup vs brief _da Sessione Cowork local_6a0ced23_
- [ ] **#p2** Test manuale reset demo form Newsletter + EOI + Waitlist sito Angelini Academy _da Sessione Cowork local_6a0ced23_
- [ ] **#p2** Test manuale HeroBridgeConstellation scroll-driven sito Angelini Academy _da Sessione Cowork local_6a0ced23_
- [ ] **#p2** Valutare architettura sito Angelini Academy doppio binario (area pubblica + area riservata "Angelini people" con login → catalogo programmi LBS/IMD/Bocconi/calendario interno) _da Sessione Cowork local_6c45a690_
- [ ] **#p2** Subscribe Google AI Pro ($19.99/mese, cancellabile post-test) per test reel Veo 3.1 Fast → pitch 31/5 _da Sessione Cowork local_afc8645b_
- [ ] **#p2** Generare 8 varianti reel (2×4 prompt) con Veo 3.1 Fast su Gemini app _da Sessione Cowork local_afc8645b_
- [ ] **#p2** Montaggio CapCut 4 clip + closing frame SVG (palette #003087+#FF8200), export 1080p MP4 H.264 _da Sessione Cowork local_afc8645b_
...
- [ ] **#p2** Federico+Simone: fix duplicazione blocco requisiti critici nella schermata wizard Venue Finder _da [[Venue Finder]]_
- [ ] **#p2** Federico+Simone: fix rendering markdown chat Sally (`\n\n`/`\n-` letterali nelle risposte) _da [[Venue Finder]]_
- [ ] **#p2** Verificare con Simone segnalazioni Compilatore inviate da Marta 11/5 (RAEE Unik + marchio Unik) _da [[Eldis Compilatore]]_
- [ ] **#p2** Identificare il "professore consulente UCL principe" citato da Elena (consulente Academy strategico, potenziale stakeholder) _da call 11/5_
- [ ] **#p2** Ping leggero (WhatsApp/mail breve) [[Laura Garbarino]] (warning, 13gg+, AD NoLoop) — entro 7gg _da `crm-velocity` 12/5_
- [ ] **#p2** Touchpoint [[Paolo Donzelli]] (29gg+, CFO firmatario contratti) — questa settimana _da `crm-velocity` 12/5_
...
- [ ] **#p2** Review interna finale Angelini Academy — tutti, **27-28/5** _da prep call 11/5_
- [ ] **#p2** Conferma a [[Andrea Pasquali]] per PresidIA + Achipont _da [[Jakala]]_
- [ ] **#p2** Se non scelto Jakala: comunicazione "ne riparliamo a settembre", mantenere relazione _da [[Jakala]]_
...
- [ ] **#p2** Federico+Simone: lettura + risposta mail Germano su Eye Cookies (prodotti fisici, foto) _da [[Eye Cookies]]_
- [ ] **#p2** Verifica al 13/5 dell'adoption Lists; se Federico non spunta, attivare plan B (canale Teams) _da [[99 - System/Workflow Delivery Soolutions]]_
...
- [ ] **#p2** Piano implementazione export selettivo manuale Eldis _da [[Eldis Compilatore]]_
- [ ] **#p2** Fix persistenza filtri Builder (anomalia gratuita) _da [[Eldis Compilatore]]_
- [ ] **#p2** Fattura prossima Eldis: includere consuntivo token AI fino a oggi _da [[Eldis Compilatore]]_
- [ ] **#p2** Verifica codice gamma UnicTable post invio specifiche da Marta _da [[Eldis Compilatore]]_
