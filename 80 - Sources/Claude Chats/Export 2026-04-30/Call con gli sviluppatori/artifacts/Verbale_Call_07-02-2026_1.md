...
- **Allineamento:** Carlo e Federico (poi corretto: Carlo e Simone) si sentiranno **sabato 08 tardo pomeriggio** per revisione architetturale e fattibilità. Federico non partecipa (impegnato a cena).
...
- **Fix permessi pagina scraper LeadMe:** Verificare che i permessi di autenticazione siano OK per tutti gli utenti, non solo il team dev (Solutions — Simone, duedate: 09/02/2026)
...
- **Preparazione demo/PoC Eye Cookies per BAT:** Definire formato — demo live con telecamera e scaffale e/o presentazione + moodboard — per incontro del 26/02 (Carlo + Simone, duedate: TBD — entro ~25/02/2026)
...
- **Aggiornamento Compilatore AI:** Simone aggiornerà Carlo sui progressi del Compilatore AI (Simone, duedate: 08/02/2026)
...
- Il team ha ribadito che l'**ambiente dev non è valido per dati di produzione**; il cliente (NoLoop/LeadMe) deve essere formalmente istruito a lavorare esclusivamente in prod.
