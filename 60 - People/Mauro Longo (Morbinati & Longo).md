---
type: person
category: fornitore-legale
role: Avvocato (legale HeyAI)
...
- **Email**: m.longo@morbinatilongo.it
- **Fornitore di servizi**: legale esterno HeyAI
...
- Riferimento per contrattualistica complessa (multi-AI, IP, dilazioni pagamento, change request)
- Attualmente owner della stesura contratto Wave 2 NoLoop
- Avv. Lorenzo Albanese (AGMLex) era stato consultato a marzo per bozza contratto base, ma il referente principale ora è Morbinati & Longo
- **Stile redazione**: impianto difensivo a favore del Fornitore (HeyAI). Usa schemi protettivi consolidati (silenzio-assenso UAT, obbligazione di mezzi, esclusione lucro cessante, massimale 12 mesi, disclaimer AI/AI Act). Lascia clausole "valutare congiuntamente" (es. escrow art. 4.5) per non vincolare il Fornitore. Numerazione: refuso "1.2" invece di "2.2" in Art. 2 (probabilmente copy-paste, da segnalare)

## Sessioni Cowork correlate

- 2026-05-11 — `local_5e5e0b1a` — Analyze NoLoop Wave 2 legal document: analisi completa bozza 7/5 + 7 decisioni Carlo + workflow finalizzato 11/5 sera (no call con Longo, call interna Carlo+Andrea 12-14/5 → email diretta con commenti consolidati a Longo entro ven 15/5). Punto aperto: verificare se Longo ha già emesso quotazione/preventivo per la propria stesura → [[2026-05-11 - Indice sessioni#Sessione 8 — Analyze NoLoop Wave 2 legal document (bozza contratto Longo)]]
...
- **11/6 15:26 — Andrea propone riunione di chiarimento** ("crediamo ci siano state delle incomprensioni generali").
- **11/6 13:16 — WhatsApp Bruno a Carlo**: contesta la parcella ("mai conferito un mandato ma semplicemente chiesto un preventivo. Puoi chiarire?") — risposta Carlo: allineato con la decisione, chiarimento in call.
- ⚠️ **Attenzione operativa**: la condizione dei 7 giorni scade ~18/6 — fare la call di chiarimento PRIMA della scadenza per non perdere la "riduzione" se si decide di pagare.
- [ ] **#p1 Carlo/Andrea**: call di chiarimento con Longo entro il 18/6 (la condizione di pagamento a 7 giorni scade)
