...
---
<!-- auto-updated by cowork-sessions-index 2026-05-08 20:30 | source-session: local_8f7eeba2-4b9b-419d-a9ef-04efbf81cd06 | source-lastActive: 2026-05-08 ~19:00 -->
...
CEO di FuturItaly. **Cliente strategico** per HeyAI tramite [[_Futuritaly|FuturItaly]] (Osservatorio Strategico, FutureKids, Sito Futuritaly, gara Angelini Academy via FuturItaly). La relazione operativa la gestisce [[Lavinia Ferrari]] internamente — Claudia interviene come decisore finale.

Profilo: **esigente, ha standard alti, ha già rifiutato proposte in passato**. Richiede protezione della partnership commerciale, non semplici aumenti di prezzo. Pattern documentato in chat strategiche di pricing (Apr 2026): sull'Osservatorio il numero €38K era "già circolato" e qualsiasi aumento secco rischia di rompere il rapporto.
...
- Loro passano a noi clienti che cercano sviluppo software o marketing
- Noi passiamo a loro clienti che chiedono agevolazioni fiscali
- Esplorare insieme agevolazioni per HeyAI stessa
...
- [[_Futuritaly|FuturItaly]] (parent, tutti i progetti sotto-cliente passano da lei come decisore finale)
- [[Osservatorio Strategico]] — quotazione €42K (alzata post Silencio 4/5)
- [[FutureKids]]
- [[Sito Futuritaly]]
- [[_Angelini Academy|Angelini Academy]] (gara competitiva via FuturItaly come intermediario)

## Cluster FuturItaly (a chi riporta cosa)

- **Claudia Bugno** (CEO, decisore finale)
- [[Leonardo Delbufalo]] — PM/coordinator Osservatorio
- [[Lavinia Ferrari]] — champion progetto, alleata interna, co-founder informale [[PresidIa]]
- [[Elena Chiti]] — Key Account, owner relazione cliente Angelini Academy (gara)
- [[Daniele Caporale]] — Communication strategist (gara Angelini)
- Paolo Passaro — expert finanza agevolata, main end-user Osservatorio
- Lidia Boccanera — international/EU tenders expert, Interreg
- Max — sponsor/decision-maker Osservatorio

## Note operative

- Per pitching live: tarare tono su business value e tempo risparmiato, non su tecnologia
- Decisioni finali su FuturItaly passano da lei — non chiudere offerte assumendo che [[Lavinia Ferrari]] o [[Leonardo Delbufalo]] possano firmare in autonomia
- Relazione Bruno ↔ Claudia (agevolazioni) è canale parallelo da non confondere con la relazione operativa Carlo/Michele ↔ Lavinia/Leonardo

## Sessioni Cowork correlate

- 2026-05-08 sera — `local_8f7eeba2` — creazione scheda da zero (cluster FuturItaly — broken wikilink rilevato in [[Leonardo Delbufalo]] durante setup `vault-link-checker`) → [[2026-05-08 - Indice sessioni#Sessione 8 — Setup scheduled vault-link-checker task + chiusura audit]]
